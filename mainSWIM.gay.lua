...
local title,title2 = '.gay | v%s | fps %s | ping %s', 'SWIM.gay - REINFORCED BY 6nt0n'
...
local Library, ThemeManager, SaveManager, _esplib = nil, nil, nil, nil 
do
    local repo = 'https://raw.githubusercontent.com/SWIMHUBISWIMMING/old_repo/blob/main/'
    Library = loadstring(game:HttpGet('https://raw.githubusercontent.com/SWIMHUBISWIMMING/swimhub/refs/heads/main/library_main.lua'))()
    ThemeManager = loadstring(game:HttpGet('https://raw.githubusercontent.com/SWIMHUBISWIMMING/swimhub/refs/heads/main/library_theme.lua'))()
    SaveManager = loadstring(game:HttpGet('https://raw.githubusercontent.com/SWIMHUBISWIMMING/swimhub/refs/heads/main/library_save.lua'))()
    _esplib = loadstring(game:HttpGet('https://raw.githubusercontent.com/SWIMHUBISWIMMING/swimhub/refs/heads/main/old_esp_library.lua'))()
end
...
local varsglobal = {
    ...
    spamsettings = {
        ...
        real = {
            ...
            [2] = {
                "cheap game scripts @6nt0n",
                "quanity over quality @6nt0n",
                "good and cheap @6nt0n",
                "not racist sigma person @6nt0n",
                "free script @6nt0n",
            }
        },
        customword = "",
...
local EnemyEspTab = TabEsp:AddTab('PLAYERS')
local TeamEspTab = TabEsp:AddTab('TEAM')
...
(function()
    ...
    Misc:AddToggle('showwatermark', {Text='WATERMARK',Default=false,Callback=function(v)draw:changevis(v)end}):AddColorPicker('watercolor', {Default = Color3.fromRGB(90, 100, 255),Title = 'watermark color',Transparency = 0})
...
luatab:AddLabel("Work In Progress")
if noadonis then
...
do
    ...
    local lines = {}
    -- // Drawings
    local outline = utility:new("Circle",{
        Visible =  true,
...
Misc:AddInput('customwordtextbox', {
    Default = 'SWIM.gay on top',
    Numeric = false,
    Finished = false,

    Text = 'CUSTOM WORD',
    Tooltip = 'Use your own custom words',
...
Misc:AddButton('REJOIN', function()
    if #plrs:GetPlayers() <= 1 then
        plrs.LocalPlayer:Kick("\rejoining")
        wait()
...
local lonesurvival = Tabs.Main:AddLeftGroupbox("ROST - LONE")
